"""Hybrid non-recursive transformer, GDN:GQA = 2:1.

Layer stack tiles the (gdn, gdn, gqa) pattern through all 6 layers, each layer
with independent weights, applied once (single pass).
"""
...
Config = importlib.import_module("src.gdn_baseline.2to1.config").Config
